...
(function (exports,main_core,im_v2_application_core,im_v2_const,im_v2_lib_rest,im_v2_lib_logger,im_v2_lib_notifier) {
	  ...
	  babelHelpers.createClass(StickerService, [{
	          ...
	          while (1) switch (_context4.prev = _context4.next) {
	            case 0:
	              ...
	              return im_v2_lib_rest.runAction(im_v2_const.RestMethod.imV2StickerPackLink, {
	                ...
	                _classPrivateMethodGet(_this, _showNotifyForError, _showNotifyForError2).call(_this, firstError.code);
	                im_v2_lib_logger.Logger.warn('StickerService: link pack error', errors);
	                im_v2_lib_notifier.Notifier.sticker.handleLinkPackError();
	              });
	            case 4:
	            case "end":
	          ...
	          while (1) switch (_context5.prev = _context5.next) {
	            case 0:
	              ...
	              return im_v2_lib_rest.runAction(im_v2_const.RestMethod.imV2StickerPackAdd, {
	                ...
	                _classPrivateMethodGet(_this2, _showNotifyForError, _showNotifyForError2).call(_this2, firstError.code);
	                im_v2_lib_logger.Logger.warn('StickerService: pack creation error', errors);
	              });
	            case 3:
	              rawData = _context5.sent;
	              pack = rawData.pack, stickers = rawData.stickers;
	              packsPromise = im_v2_application_core.Core.getStore().dispatch('stickers/packs/addNew', pack);
	              stickersPromise = im_v2_application_core.Core.getStore().dispatch('stickers/set', stickers);
	          ...
	          while (1) switch (_context7.prev = _context7.next) {
	            case 0:
	              ...
	              return im_v2_lib_rest.runAction(im_v2_const.RestMethod.imV2StickerAdd, {
	                ...
	                _classPrivateMethodGet(_this3, _showNotifyForError, _showNotifyForError2).call(_this3, firstError.code);
	    ...
	    value: function () {
	      var _deleteStickerFromPack = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(_ref10) {
	        var ids, packId, packType, remainStickers;
	        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
	          while (1) switch (_context13.prev = _context13.next) {
	            case 0:
	              ...
	              remainStickers = im_v2_application_core.Core.getStore().getters['stickers/getByPack']({
	                id: packId,
	                type: packType
	              });
	              if (!main_core.Type.isArrayFilled(remainStickers)) {
	                void im_v2_application_core.Core.getStore().dispatch('stickers/packs/delete', {
	                  id: packId,
	                  type: packType
	                });
	...
	function _showNotifyForError2(errorCode) {
	  var notifications = {
	    MAX_STICKERS_ERROR: im_v2_lib_notifier.Notifier.sticker.handleAddStickersError,
	    MAX_PACKS_ERROR: im_v2_lib_notifier.Notifier.sticker.handleAddPackError
	  };
