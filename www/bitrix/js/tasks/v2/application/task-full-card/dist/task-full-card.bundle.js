	  ...
	  computed: {
	    ...
	    menuItems() {
	      if (this.isTemplate) {
	        ...
	        this.getDeleteTemplate()].filter(item => item !== null);
	      }
	      const statuses = {
	...
	const App = {
	  ...
	  async created() {
	    ...
	    if (!this.isEdit && !this.task) {
	      ...
	      if (this.analytics.context) {
	        var _this$group3, _this$initialTask$aud, _this$initialTask2, _this$initialTask2$au, _this$initialTask$acc, _this$initialTask3, _this$initialTask3$ac;
	    ...
	    if (this.isEdit && this.analytics.context) {
	      var _this$task$auditorsId, _this$task6, _this$task6$auditorsI, _this$task$accomplice, _this$task7, _this$task7$accomplic;
	  ...
	  methods: {
	    ...
	    async handleTemplate(templateId) {
	      var _this$task10, _this$task10$fileIds;
	      this.isLoading = true;
	      await tasks_v2_provider_service_templateService.templateService.getTask(templateId, this.taskId);
	      if (((_this$task10 = this.task) == null ? void 0 : (_this$task10$fileIds = _this$task10.fileIds) == null ? void 0 : _this$task10$fileIds.length) > 0) {
	        var _this$task11;
	        await tasks_v2_provider_service_fileService.fileService.get(this.taskId).list((_this$task11 = this.task) == null ? void 0 : _this$task11.fileIds);
	      }
	      await this.$store.dispatch(`${tasks_v2_const.Model.Tasks}/clearFieldsFilled`, this.taskId);
	      this.isLoading = false;
	    },
