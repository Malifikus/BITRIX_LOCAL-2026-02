jn.define('call/calls/bitrix-jwt', (require, exports, module) => {
	...
	class BitrixCallJwt
	{
		constructor(params)
		{
			...
			this.createdFromPush = params.createdFromPush || false;
		...
		attachToConference()
		{
			console.log('attachToConference')
			return new Promise((resolve, reject) => {
				...
				BXJwtClientWrapper.getClient().then((client) => {
					...
					try
					{
						...
						console.log('this.bitrixCallDev', this.bitrixCallDev)
					}
					catch (e)
					{
						CallUtil.error(e);
					...
					if (!this.bitrixCallDev)
					{
						...
						console.log('Error: could not create bitrix dev call')
