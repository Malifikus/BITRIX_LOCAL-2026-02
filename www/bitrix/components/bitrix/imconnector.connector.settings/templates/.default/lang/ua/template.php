...
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_NO_GRANTS"] = "Недостатньо прав для підключення каналу.<br />Зверніться до адміністратора вашого Бітрікс24.";
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_NO_GRANTS_BUTTON"] = "Написати адміністратору";
