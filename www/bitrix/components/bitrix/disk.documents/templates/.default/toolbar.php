		...
		'items' => [
			[
				...
				'onclick' =>  new UI\Buttons\JsCode(
					'BX.Disk.Documents.Toolbar.createDocx("'.$item['code'].'", this, "'.Loc::getMessage('DISK_DOCUMENTS_TOOLBAR_CREATE_DOC') .'");'
				)
			],
			[
				'text' => Loc::getMessage('DISK_DOCUMENTS_TOOLBAR_CREATE_XLS'),
				'onclick' => new UI\Buttons\JsCode(
					'BX.Disk.Documents.Toolbar.createXlsx("'.$item['code'].'", this, "'.Loc::getMessage('DISK_DOCUMENTS_TOOLBAR_CREATE_XLS') .'");'
				)
			],
			[
				'text' => Loc::getMessage('DISK_DOCUMENTS_TOOLBAR_CREATE_PPT'),
				'onclick' => new UI\Buttons\JsCode(
					'BX.Disk.Documents.Toolbar.createPptx("'.$item['code'].'", this, "'.Loc::getMessage('DISK_DOCUMENTS_TOOLBAR_CREATE_PPT') .'");'
				)
			],
		]
	];
