...
(function (exports,disk_users,main_polyfill_intersectionobserver,main_loader,main_popup,clipboard,disk_externalLink,disk_sharingLegacyPopup,ui_dialogs_messagebox,ui_ears,main_core_events,main_core,ui_navigationpanel,ui_tour) {
	...
	var Toolbar = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Toolbar, null, [{
	    ...
	    key: "createDocx",
	    value: function createDocx(service, element, nodeName) {
	    ...
	    key: "createXlsx",
	    value: function createXlsx(service, element, nodeName) {
	      var code = this.resolveServiceCode(service);
	      if (code) {
	        var nodeToBind = this.resolveNodeToBind(element);
	    ...
	    key: "createPptx",
	    value: function createPptx(service, element, nodeName) {
	      var code = this.resolveServiceCode(service);
	      if (code) {
	        var nodeToBind = this.resolveNodeToBind(element);
