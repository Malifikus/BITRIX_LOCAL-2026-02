<?php
$MESS["DOCGEN_SETTINGS_PERMS_FEATURE_PANEL"] = "Uprawnienia pracowników do obiektów CRM są dostępne w planach płatnych.";
...
$MESS["DOCGEN_SETTINGS_PERMS_MODULE_UI_ERROR"] = "Wymagany jest moduł „Biblioteka UI”.";
