...
$MESS["TASKS_COUNTER_WO_DEADLINE_PLURAL_0"] = "без кінцевого терміну";
$MESS["TASKS_COUNTER_WO_DEADLINE_PLURAL_1"] = "Без кінцевого терміну";
$MESS["TASKS_COUNTER_WO_DEADLINE_PLURAL_2"] = "Без кінцевого терміну";
...
Лічильники прострочених завдань і нових коментарів допоможуть вам не пропустити головне.<br><br>
Завдання в будь-якому поданні (список, мій план, терміни або канбан) сортуються за активністю. Завдання підніметься в списку, якщо в ньому з'явиться коментар або зміниться кінцевий термін.<br>";
$MESS["TASKS_TEMPLATE_SPOTLIGHT_SIMPLE_COUNTERS_BUTTON"] = "Детальніше";
$MESS["TASKS_TEMPLATE_SPOTLIGHT_SIMPLE_COUNTERS_MSGVER_1"] = "Стежити за виконанням завдань тепер ще простіше!<br><br>
Лічильники протермінованих завдань і нових коментарів допоможуть вам не пропустити головне.<br><br>
Завдання в будь-якому поданні (список, мій план, строки або канбан) сортуються за активністю. Завдання підніметься в списку, якщо в ньому з'явиться коментар або зміниться кінцевий термін.<br>";
$MESS["TASKS_TEMPLATE_SPOTLIGHT_TIMELINE"] = "Плануйте вирішення своїх завдань і стежте за кінцевим терміном у новому поданні.";
