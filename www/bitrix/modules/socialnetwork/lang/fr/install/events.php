...
#MESSAGE# - Message";
$MESS["SONET_INVITE_GROUP_MESSAGE"] = "Message de #SITE_NAME#
------------------------------------------
...
Cliquez sur le lien ci-dessous pour répondre à l'invitation :
...
$MESS["SONET_INVITE_GROUP_SUBJECT"] = "#SITE_NAME# : Invitation à rejoindre le groupe";
...
$MESS["SONET_NEW_EVENT_DESC"] = "#ENTITY_ID# - ID source de l'évènement
#LOG_DATE# - Date d'enregistrement
#TITLE# - Intitulé
#MESSAGE# - Message
#URL# - Adresse
#ENTITY# - Lieu d'enregistrement de l'évènement
...
#SUBSCRIBER_ID# - ID destinataire";
$MESS["SONET_NEW_EVENT_GROUP_MESSAGE"] = "Salutations de #SITE_NAME# !
------------------------------------------

Bonjour, #SUBSCRIBER_NAME# !

Les modifications suivantes ont été effectuées dans le groupe #GROUP_NAME# :
...
Vous pouvez ouvrir le site en cliquant sur le lien suivant :

http://#SERVER_NAME##URL#

Cette notification a été générée automatiquement.";
$MESS["SONET_NEW_EVENT_GROUP_NAME"] = "Un nouvel Evénement du Groupe";
$MESS["SONET_NEW_EVENT_GROUP_SUBJECT"] = "#SITE_NAME# : Nouvel événement de groupe";
...
Pour accéder à la page de l'évènement, veuillez cliquez sur le lien :

#URL#
Ce message a été généré automatiquement.";
$MESS["SONET_NEW_EVENT_NAME"] = "Ajouter un évènement";
...
$MESS["SONET_NEW_EVENT_USER_NAME"] = "Nouvel évènement de l'utilisateur";
...
$MESS["SONET_REQUEST_GROUP_MESSAGE"] = "Message de #SITE_NAME#
------------------------------------------
