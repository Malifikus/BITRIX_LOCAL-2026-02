...
$MESS["MAIN_INSTALL_EVENT_TYPE_USER_CODE_REQUEST_DESC"] = "#USER_ID# - ID de l'utilisateur
...
$MESS["MAIN_USER_INVITE_TYPE_DESC"] = "#ID# - ID de l'utilisateur
#LOGIN# - Nom de l'utilisateur
#URL_LOGIN# - Identifiant codé pour son utilisation dans une URL
#EMAIL# - Adresse e-mail
#NAME# - Prénom
#LAST_NAME# - Nom de famille
#PASSWORD# - Mot de passe de l'utilisateur
#CHECKWORD# - Mot de vérification du mot de passe
#XML_ID# - ID de l'utilisateur pour la connexion aux sources extérieures
