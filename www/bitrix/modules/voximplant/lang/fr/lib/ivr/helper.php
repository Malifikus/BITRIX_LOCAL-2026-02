<?
$MESS["IVR_LICENSE_POPUP_FOOTER_2"] = "Le menu vocal (SVI) est réservé aux offres commerciales sélectionnées.";
$MESS["IVR_LICENSE_POPUP_HEADER_2"] = "Disponible uniquement avec les offres commerciales.";
$MESS["IVR_LICENSE_POPUP_ITEM_1"] = "Menus imbriqués";
$MESS["IVR_LICENSE_POPUP_ITEM_2"] = "Utiliser des fichiers audio personnalisés pour communiquer des messages aux clients";
$MESS["IVR_LICENSE_POPUP_ITEM_3"] = "Lire le texte à l'aide d'un moteur vocal (différentes voix sont disponibles ; options pour régler la vitesse et le volume)";
