...
$MESS["VI_DOCS_BODY_2"] = "É exigido por lei em alguns países que a companhia telefônica deve solicitar sua documentação jurídica antes de você poder usar seus números alugados.<br>Essa é uma exigência se você quiser manter e usar os números durante o prazo de concessão. Você não poderá usar os números até fazer o carregamento da documentação necessária e obter a aprovação.";
$MESS["VI_DOCS_COUNTRY_RU"] = "Rússia";
$MESS["VI_DOCS_SERVICE_ERROR"] = "Erro ao enviar solicitação para serviço de carregamento de documento";
$MESS["VI_DOCS_SERVICE_UPLOAD"] = "Carregar";
...
$MESS["VI_DOCS_TABLE_OWNER"] = "Proprietário";
...
$MESS["VI_DOCS_UPLOAD_NOTICE"] = "Observe que a papelada que você está prestes a enviar será carregada diretamente para Voximplant, Inc e será tratada de acordo com a legislação do país correspondente. Bitrix24 não irá coletar, armazenar ou processar quaisquer dados associados a esses documentos.";
$MESS["VI_DOCS_UPLOAD_WHILE_RENT"] = "Se sua documentação precisar ser verificada para alugar um número de telefone, a interface de usuário de aluguel de número mostrará o formulário de carregamento da documentação";
