<?php
$MESS["INTRANET_DISK_PROMO_DESC_MSGVER_1"] = "Hoje, podemos acessar a Internet em praticamente qualquer lugar, a qualquer hora. E, ainda, podemos encontrar situações em que o acesso ao armazenamento de arquivos online está indisponível: por exemplo, em um avião. Isso não significa que você tenha que interromper o seu trabalho! O aplicativo da área de trabalho Drive irá sincronizar todos os arquivos com cópias locais no seu computador. Edite seus arquivos offline - todas as alterações serão sincronizadas automaticamente com a Nuvem assim que a conexão à Internet estiver disponível.";
...
$MESS["INTRANET_DISK_PROMO_STEP1_TITLE_MACOS"] = "Baixe e instale o Bitrix24 para macOS: #INTEL_LINK_START#Intel#INTEL_LINK_END# ou #ARM64_LINK_START#ARM64#ARM64_LINK_END#";
...
$MESS["INTRANET_DISK_PROMO_STEP2_TITLE_MSGVER_1"] = "Conectar Drive";
