<?php
$MESS["INTRANET_DISK_PROMO_DESC_MSGVER_1"] = "De nos jours, vous pouvez accéder à Internet presque n'importe où et n'importe quand. Et pourtant, dans certaines situations il s'avère impossible de trouver un espace de stockage de fichiers en ligne disponible : par exemple, dans un avion. Cela ne signifie pas que vous devez interrompre votre travail ! L'application de bureau Bitrix24 Drive synchronisera tous vos fichiers avec des copies locales sur votre ordinateur. Modifiez vos fichiers en hors ligne : tous les changements seront automatiquement synchronisés avec le cloud dès qu'une connexion à Internet sera disponible.";
...
$MESS["INTRANET_DISK_PROMO_STEP1_TITLE_MACOS"] = "Téléchargez et installez Bitrix24 pour macOS : #INTEL_LINK_START#Intel#INTEL_LINK_END# ou #ARM64_LINK_START#ARM64#ARM64_LINK_END#";
...
$MESS["INTRANET_DISK_PROMO_STEP2_TITLE_MSGVER_1"] = "Connecter Bitrix24 Drive";
