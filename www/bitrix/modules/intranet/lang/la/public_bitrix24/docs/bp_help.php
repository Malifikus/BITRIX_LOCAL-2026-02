...
<p>Hay dos tipos más comunes de procesos de negocio: </p>
 <ul>
    ...
    <li>a <b>Proceso de negocio impulsado por el estado</b> que no tiene un punto inicial o final; El estado del proceso se cambia en tiempo de ejecución por el procesos de negocio. Tales procesos de negocio pueden, teóricamente, terminar en cualquier etapa.</li>
   </ul>
