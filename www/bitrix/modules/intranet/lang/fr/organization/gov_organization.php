...
$MESS["BITRIX24_HELP_VIDEO_TITLE_13"] = "Structure de la société";
$MESS["BITRIX24_HELP_VIDEO_TITLE_FULL_13"] = "Structure de la société";
...
$MESS["BLOG_DEMO_MESSAGE_BODY_1"] = "Chers collègues, le portail intranet est officiellement ouvert depuis aujourd'hui.

Cela signifie que chaque utilisateur dispose à présent des droits pour consulter les informations publiques et a reçu un mot de passe pour accéder à son espace privé.
...
$MESS["CAL_COMPANY_SECT_DESC_1"] = "Évènements ayant lieu aux bureaux de Londres";
$MESS["CAL_COMPANY_SECT_DESC_2"] = "Évènements ayant lieu aux bureaux de Paris";
...
$MESS["CONFIG_OTP_SECURITY_INFO2"] = "<br/>Pour activer l'identification à deux étapes, un utilisateur doit installer l'application OTP Bitrix24 sur son téléphone portable. Cette application peut être téléchargée sur AppStore ou sur GooglePlay.<br/><br/>
Les utilisateurs qui ne disposent pas d'un appareil mobile approprié doivent être équipés d'un matériel spécial : eToken Pass. De nombreux revendeurs en proposent, comme :
...
$MESS["EC_ADD_MEMBERS_FROM_STR_TITLE"] = "Ajouter des participants à l'évènement depuis la structure de l'organisation";
...
$MESS["IM_C_ABOUT_OPEN"] = "Un chat public est ouvert à l'ensemble de vos collègues. #BR##BR# Utilisez ce chat pour discuter des sujets ayant une importance pour n'importe quelle personne de votre entreprise.#BR##BR# Une fois un chat public créé, une notification est envoyée sur le #CHAT_START#chat commun#CHAT_END#. Vos collègues peuvent ensuite voir les messages du chat et le rejoindre s'ils le souhaitent.#BR##BR# Votre premier message est essentiel pour que les autres personnes soient intéressées à rejoindre votre nouveau chat.";
...
$MESS["INTRANET_USTAT_COMPANY_INV_BAR_CRM"] = "Utilisation de fonctionnalité : CRM";
...
$MESS["INTRANET_USTAT_SECTION_CRM_HELP_INVOLVEMENT"] = "Pourcentage d'utilisateurs qui ont été actifs dans le CRM pendant la période choisie. Ce nombre est/peut être limité par le nombre d'utilisateurs ayant accès au CRM.";
...
$MESS["INTR_MAIL_MANAGE_SETUP_ALLOW_CRM"] = "Les employés peuvent connecter leur boîte mail au CRM";
...
$MESS["SONET_LIVEFEED_RENDERPARTS_USER_ALL"] = "À tous les utilisateurs";
...
$MESS["W_IB_ABSENCE_2_PREV"] = "Voyage d'affaires dans une succursale de l'entreprise.";
