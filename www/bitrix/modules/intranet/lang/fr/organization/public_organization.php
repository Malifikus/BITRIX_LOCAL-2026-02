...
";
$MESS["APP_RIGHTS"] = "Droits d'accès des utilisateurs";
...
L'identification en deux étapes comprend deux niveaux de vérification. Le premier est votre mot de passe principal. Le deuxième niveau est un code à usage unique envoyé sur votre appareil mobile (ou votre clé électronique physique).<br/><br/>
...
Exécutez l'application sur votre appareil mobile : <br/><br/>
...
Les accès configurables aux espaces du portail nous apportent des fonctionnalités de travail en équipe : nous pouvons éditer des documents, créer des groupes de travail, détailler des rapports, et le tout ensemble !
...
Les utilisateurs peuvent poster sur les forums, envoyer des demandes à l'assistance technique et au service d'approvisionnement, échanger et partager des documents, discuter des actualités de l'organisation, et recevoir les dernières informations de la direction.
...
$MESS["CAL_COMPANY_SECT_DESC_1"] = "Évènements du bureau de Londres";
$MESS["CAL_COMPANY_SECT_DESC_2"] = "Évènements du bureau de Paris";
...
$MESS["CONFIG_ALLOW_NEW_USER_LF"] = "Publier une nouvelle notification utilisateur sur le Flux d'activités";
...
$MESS["EC_ADD_MEMBERS_FROM_STR_TITLE"] = "Ajouter les participants à l'évènement de la structure de l'organisation";
...
$MESS["INTRANET_USTAT_SECTION_CRM_HELP_INVOLVEMENT"] = "Pourcentage d'utilisateurs qui ont été actifs dans le CRM au cours de la période donnée. Ce nombre est/pourrait être limité par le nombre d'utilisateurs ayant accès au CRM.";
...
$MESS["SONET_UP1_WORK_POSITION"] = "Poste dans la communauté";
