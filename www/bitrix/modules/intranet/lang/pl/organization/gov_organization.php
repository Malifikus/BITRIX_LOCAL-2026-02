...
$MESS["CONFIG_ALLOW_NEW_USER_LF"] = "Opublikuj powiadomienie o nowym pracowniku na Aktualności";
...
$MESS["CONFIG_IM_GENERSL_CHAT_MESSAGE_JOIN"] = "Opublikuj powiadomienie o nowym pracowniku na czacie publicznym";
$MESS["CONFIG_IM_GENERSL_CHAT_MESSAGE_LEAVE"] = "Opublikuj powiadomienie o odrzuceniu pracownika na czacie publicznym";
...
$MESS["CONFIG_OTP_SECURITY_INFO"] = "Stworzyliśmy przyjazną dla użytkownika procedurę włączania dwustopniowego uwierzytelniania, którą może wykonać każdy użytkownik bez korzystania z pomocy eksperta.<br/><br/>
...
$MESS["DEMO_FEATURE_1"] = "Nieograniczona liczba użytkowników";
...
$MESS["IM_CL_STRUCTURE"] = "Dział";
$MESS["IM_CL_USER_B24"] = "Pracownik";
$MESS["IM_CTL_CHAT_STRUCTURE"] = "Struktura biura";
$MESS["IM_C_ABOUT_CHAT"] = "Czat prywatny jest widoczny tylko dla zaproszonych osób. #BR##BR# Oprócz swoich współpracowników i pracowników z biura możesz zapraszać klientów, partnerów, dostawców - każdego, kto ma własny Bitrix24. Aby dodać nową osobę, wprowadź jej imię i nazwisko, adres e-mail lub pseudonim. #BR##BR##PROFILE_START#Edytuj swój profil#PROFILE_END#, aby inni mogli cię znaleźć.";
...
$MESS["INTR_ABSC_TPL_EDIT_ENTRIES"] = "Zarządzanie użytkownikami";
$MESS["INTR_ABSC_TPL_IMPORT"] = "Importuj użytkownika";
$MESS["INTR_ABSENCE_USER"] = "Wybierz pracownika *";
...
$MESS["INTR_COMP_IS_TPL_TOOLBAR_USER_INVITE"] = "Zaproś użytkowników";
$MESS["INTR_CONFIRM_DELETE"] = "Zaproszenie zostanie usunięte nieodwracalnie.\\n\\nNa pewno chcesz usunąć użytkownika?";
$MESS["INTR_CONFIRM_FIRE"] = "Użytkownik nie będzie mógł logowac się do portalu i nie będzie widoczny w strukturze firmy. Jednakże jego lub jej dane osobiste (pliki, wiadomości, zadania itp.) pozostaną nietknięte.\\n\\nNa pewno chcesz odmówić dostępu temu użytkownikowi?";
...
$MESS["INTR_MAIL_MANAGE_SETUP_ALLOW_CRM"] = "Pracownicy mogą podłączać skrzynki pocztowe do CRM";
...
$MESS["ISV_EMP_COUNT_31"] = "#NUM# użytkownik";
...
$MESS["LICENSE_CRM_FEATURE_16"] = "Dziennik dostępu do CRM";
...
$MESS["MENU_COMPANY_SECTION"] = "Instytucja";
...
$MESS["SOCNET_CONFIRM_FIRE1"] = "Użytkownik nie będzie mógł logować się do portalu i nie będzie widoczny w strukturze firmy. Jednakże jego lub jej dane osobiste (pliki, wiadomości, zadania itp.) pozostaną nietknięte.\\n\\nNa pewno chcesz odmówić dostępu temu użytkownikowi?";
