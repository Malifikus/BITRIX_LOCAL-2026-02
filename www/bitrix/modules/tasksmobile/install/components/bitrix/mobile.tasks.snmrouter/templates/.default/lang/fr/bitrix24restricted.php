<?php
$MESS["TASK_RESTRICTED_ADMIN1_MSGVER_1"] = "<h1>Votre abonnement limite l'accès à cette option</h1><p>Les outils professionnels dans votre abonnement sont disponibles pour jusqu'à 24 utilisateurs.</p><p>Vous pouvez accorder ou retirer l'accès d'un utilisateur aux outils professionnels uniquement dans la version Web de Bitrix24.</p>";
$MESS["TASK_RESTRICTED_ADMIN2_MSGVER_1"] = "Ouvrir la version Web";
