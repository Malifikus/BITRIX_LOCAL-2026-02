...
(function (exports,main_core_events,im_v2_lib_layout,im_v2_lib_user,im_v2_lib_userStatus,im_v2_lib_logger,im_v2_lib_channel,im_v2_lib_utils,im_v2_const,im_v2_application_core,ui_vue3_vuex,im_v2_model,main_core) {
	'use strict';
	...
	class PacksModel extends ui_vue3_vuex.BuilderModel {
	  ...
	  getActions() {
	    return {
	      ...
	      addNew: (store, payload) => {
	        const preparedPack = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$7)[_formatFields$7](payload);
	        const packKey = babelHelpers.classPrivateFieldLooseBase(this, _getPackKey)[_getPackKey](preparedPack);
	  ...
	  getMutations() {
	    return {
	      ...
	      unshift: (state, payload) => {
	        const collection = new Map([[payload.key, payload.pack], ...state.collection]);
...
}((this.BX.Messenger.v2.Model = this.BX.Messenger.v2.Model || {}),BX.Event,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Const,BX.Messenger.v2.Application,BX.Vue3.Vuex,BX.Messenger.v2.Model,BX));
