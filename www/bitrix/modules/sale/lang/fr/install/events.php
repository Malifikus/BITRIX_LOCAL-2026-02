...
#ORDER_PUBLIC_URL# : lien d'affichage de la commande pour les utilisateurs non autorisés (nécessite une configuration dans les paramètres du module Boutique en ligne)
...
#EMAIL# : adresse e-mail de notification
#BCC# : adresse en copie
#ORDER_USER# : client
#DELIVERY_NAME# : nom du service de livraison
#DELIVERY_TRACKING_URL# : site du service de livraison pour obtenir plus d'informations sur le suivi
