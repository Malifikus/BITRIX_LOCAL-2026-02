...
$MESS["CRM_ACTIVITY_EMAIL_BLACKLISTED"] = "El mensaje de correo electrónico se canceló. Las siguientes direcciones están en la %link_start% lista negra %link_end%: %emails%";
$MESS["CRM_ACTIVITY_EMAIL_CREATION_CANCELED"] = "Mensaje de correo electrónico cancelado.";
$MESS["CRM_ACTIVITY_EMAIL_CREATION_LIMITED"] = "Alcanzó el límite en la cantidad de correos electrónicos que puede enviar este mes. %link_start%Detalles%link_end%.";
$MESS["CRM_ACTIVITY_EMAIL_CUSTOM_LIMITED"] = "Ha alcanzado el límite en la cantidad de correos electrónicos que puede enviar por día. Cambie el límite en la configuración del remitente.%link_start%Details%link_end%.";
...
$MESS["CRM_ACTIVITY_EMAIL_MAX_SIZE_EXCEED"] = "Se superó el tamaño máximo posible del archivo adjunto (#SIZE#)";
$MESS["CRM_ACTIVITY_EMAIL_MESSAGE_TO_MANY_RECIPIENTS"] = "No puede agregar más de 10 destinatarios";
...
$MESS["CRM_MESSAGE_NEW_TARIFF_RESTRICTION"] = "Las restricciones de su plan actual:<br/>\"Para\", \"CC\", \"BCC\" - #COUNT# Correo electrónico (destinatario)";
