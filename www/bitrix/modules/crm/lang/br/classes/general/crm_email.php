...
$MESS["CRM_EMAIL_BAD_RESP_QUEUE"] = "Um colaborador dispensado existe na fila de distribuição de e-mail para a caixa de correio \"#EMAIL#\". Eles não receberão e-mails de novas fontes, mas todos os e-mails existentes ainda serão encaminhados para esse colaborador. <a href=\"#CONFIG_URL#\">Configurar parâmetros da fila</a>.";
