...
(function (exports,main_core,main_core_events,ui_vue3,ui_uploader_core,ui_lexical_core,tasks_v2_core,tasks_v2_const,tasks_v2_provider_service_fileService,tasks_v2_component_elements_userFieldWidgetComponent,ui_bbcode_formatter_htmlFormatter,ui_system_typography_vue,ui_vue3_directives_hint,tasks_v2_component_elements_hint,ui_system_menu_vue,ui_iconSet_outline,ui_iconSet_editor,ui_textEditor,ui_iconSet_api_vue,ui_lexical_list) {
	'use strict';
...
}((this.BX.Tasks.V2.Component = this.BX.Tasks.V2.Component || {}),BX,BX.Event,BX.Vue3,BX.UI.Uploader,BX.UI.Lexical.Core,BX.Tasks.V2,BX.Tasks.V2.Const,BX.Tasks.V2.Provider.Service,BX.Tasks.V2.Component.Elements,BX.UI.BBCode.Formatter,BX.UI.System.Typography.Vue,BX.Vue3.Directives,BX.Tasks.V2.Component.Elements,BX.UI.System.Menu,BX,BX,BX.UI.TextEditor,BX.UI.IconSet,BX.UI.Lexical.List));
