<?php
$MESS["TASKS_ITEM_TASK_TEMPLATE_BAD_ASSIGNEE_ERROR"] = "L'utilisateur spécifié comme responsable n'a pas été trouvé.";
...
$MESS["TASKS_ITEM_TASK_TEMPLATE_FIELD_SE_ACCESS"] = "Droits d'accès";
$MESS["TASKS_ITEM_TASK_TEMPLATE_FIELD_SE_CHECKLIST"] = "Liste de contrôle";
$MESS["TASKS_ITEM_TASK_TEMPLATE_FIELD_SE_TAG"] = "Balises";
$MESS["TASKS_ITEM_TASK_TEMPLATE_NO_BASE_TEMPLATE_ALLOWED_ERROR_BECAUSE_MULTITASK_MSGVER_1"] = "Impossible d'assigner le modèle de base si plusieurs responsables sont spécifiés.";
...
$MESS["TASKS_ITEM_TASK_TEMPLATE_NO_MULTITASKING_ALLOWED_ERROR_BECAUSE_TYPE_1_MSGVER_1"] = "Impossible de créer un modèle de plusieurs responsables pour le nouvel utilisateur.";
