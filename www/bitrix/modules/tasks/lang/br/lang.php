...
$MESS["TASKS_ACTION_NOT_ALLOWED"] = "Esta atividade não é permitida.";
$MESS["TASKS_BAD_ASSIGNEE"] = "O responsável não foi especificado.";
...
$MESS["TASKS_RIGHTS_MORE_LINK"] = "Saiba mais sobre permissões de acesso";
$MESS["TASKS_TASK_CREATE_ACCESS_DENIED"] = "Permissão insuficiente para criar uma tarefa.";
$MESS["TASKS_TEMPLATE_CREATE_TASK_NOT_ACCESSIBLE_MSGVER_1"] = "Não é possível salvar o modelo porque o autor da tarefa selecionada não tem permissões suficientes para atribuir tarefas ao responsável selecionado ou não tem acesso ao projeto da tarefa. Configure as permissões apropriadas e tente novamente.";
$MESS["TASKS_TEMPLATE_MEMBER_CONVERT"] = "Estamos atualizando os modelos agora para torná-los ainda mais práticos. Você ainda pode continuar usando outras áreas do seu Bitrix24. Isso vai demorar apenas um pouco.";
$MESS["TASKS_TEMPLATE_MEMBER_CONVERT_TITLE"] = "Por favor, aguarde.#BR#Os modelos estarão aqui em breve.";
