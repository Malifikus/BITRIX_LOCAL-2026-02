...
$MESS["IMOL_CONFIG_KPI_FIRST_ANSWER_TEXT"] = "#OPERATOR# excedió el tiempo de respuesta inicial máximo en la conversación ##DIALOG#.";
$MESS["IMOL_CONFIG_KPI_FURTHER_ANSWER_TEXT"] = "#OPERATOR# excedió el tiempo de respuesta máximo en la conversación ##DIALOG#.";
$MESS["IMOL_CONFIG_LINE_NAME"] = "Canal Abierto #NAME#";
$MESS["IMOL_CONFIG_NO_ANSWER_NEW"] = "Lamentablemente no podemos atender su solicitud en este momento. Nos pondremos en contacto con usted lo antes posible.";
...
$MESS["IMOL_ERROR_UPDATE_EMPTY_DEPARTMENT_QUEUE"] = "La cola requiere al menos una persona (el departamento que agregó no contiene empleados)";
$MESS["IMOL_ERROR_UPDATE_EMPTY_QUEUE"] = "La cola requiere al menos una persona";
$MESS["IMOL_ERROR_UPDATE_NO_LOAD_LINE"] = "Se intentó actualizar un canal abierto inexistente";
$MESS["IMOL_ERROR_UPDATE_NO_VALID_QUEUE"] = "Se intentaron guardar datos de la cola inválidos";
